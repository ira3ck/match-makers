...
const Index = () => {
  ...
  const squad = {
    ...
    squad_pic:
      "../img/Spirited-away-ogino-chihiro-studio-ghibli-1920x1080-wallpaper.jpg",
  ...
  return (
    <Fragment>
      <Box
        ...
        style={{ backgroundImage: `url(${squad.background_squad_pic})` }}
      >
        <Box component="div" className={classes.content}>
          <Box display="flex" flexDirection="row-reverse" p={1} m={1}>
            <Box
              p={1}
              style={{
                backgroundColor: "rgba(0, 151, 19, 0.4)",
                borderRadius: " 10px",
                alignContent: "center",
              }}
            >
